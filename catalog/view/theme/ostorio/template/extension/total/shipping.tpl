		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.breadcrumb').after('<div class="alert alert-danger"><i></i>' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.breadcrumb').after('<div class="alert alert-danger"><i></i>' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
